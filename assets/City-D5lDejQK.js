import{S as D,C as W,a as g,V as z,E,L as R,b as G,c as S,d as A,B as H,e as j,f as C,A as V,P as $,g as O,D as b,M as B,h as N,T as Y,i as Q,j as X,R as Z,k as q,l as K}from"./three.module-DxqIPYNp.js";import{g as f}from"./index-DjKJqAo0.js";import{c as p,r as y}from"./init-BnaqhK5o.js";import{O as J}from"./OrbitControls-UtDBv3EV.js";import{e as _}from"./eventHub-C6b7Eskn.js";import{G as ee}from"./GLTFLoader-CeTFqpKO.js";import{r as L,o as U,w as te,a as u,c as h,_ as ne,b as l,F as M,d as F,t as v,n as ae,u as x,p as oe,e as ie,f as re,g as P}from"./index-14mOdFxx.js";let d=new D,se=new URL("/assets/1-Cn7Q6pgF.jpg",import.meta.url).href,le=new URL("/assets/2-C6cQCttB.jpg",import.meta.url).href,ce=new URL("/assets/3-Cu5ZW8wg.jpg",import.meta.url).href,me=new URL("/assets/4-r2ZpB5va.jpg",import.meta.url).href,de=new URL("/assets/5-CPesry4o.jpg",import.meta.url).href,ue=new URL("/assets/6-CcA8nC2x.jpg",import.meta.url).href,k=new W().load([se,le,ce,me,de,ue]);d.background=k;d.environment=k;const T=new J(p,y.domElement);T.enableDamping=!0;function he(e){e.material.onBeforeCompile=n=>{n.fragmentShader=n.fragmentShader.replace("#include <dithering_fragment>",`
